...
Route::middleware('verified.role:ADMIN')->group(function () {
    ...
    Route::get('/admin/verifications/{profile}', [
        AdminController::class,
        'verificationHistory'
    ]);
...
Route::middleware('verified.role:FOOD_DONOR')->group(function () {
    ...
    Route::post('/donations/{donation}/cancel', [
        DonationController::class,
        'cancel'
    ]);

    Route::post('/donations/{donation}/photos', [
        DonationController::class,
        'storePhotos'
    ]);

    Route::delete('/donations/{donation}/photos/{photo}', [
        DonationController::class,
        'destroyPhoto'
    ]);
});
